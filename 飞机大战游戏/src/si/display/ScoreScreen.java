...
public class ScoreScreen extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawString(g, "Defenders Hall of Fame", new Rectangle(0, 0, DefenderGame.SCREEN_WIDTH, DefenderGame.SCREEN_HEIGHT / 8),
                36);
        ...
        for (int i = 0; i < scores.length; i++) {
            ...
            g.drawString(score.getName(), 2 * DefenderGame.SCREEN_WIDTH / 6, 96 + i * 32);
            g.drawString("" + score.getScore(), 4 * DefenderGame.SCREEN_WIDTH / 6, 96 + i * 32);
        }
